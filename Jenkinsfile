pipeline {
    ...
    environment {
        ...
        // Credentials
        SMTP_HOST        = credentials('smtp-host-demo')
        SMTP_PORT        = '587'
        SMTP_USER        = credentials('smtp-user-demo')
        SMTP_PASS        = credentials('smtp-pass-demo')
        CONFLUENCE_BASE  = credentials('confluence-base-demo')
        CONFLUENCE_USER  = credentials('confluence-user-demo')
        CONFLUENCE_TOKEN = credentials('confluence-token-demo')
        CONFLUENCE_SPACE = 'DEMO'
        CONFLUENCE_TITLE = 'Jenkins CI Demo Test Report'
        GITHUB_CREDENTIALS = credentials('github-credentials-demo')
        ...
        stage('Checkout from GitHub') {
            steps {
                ...
                checkout([
                    ...
                    branches: [[name: '*/main']],
                    userRemoteConfigs: [[
                        url: 'https://github.com/devopsuser8413/flask-login-ci-confluence-win-demo.git',
